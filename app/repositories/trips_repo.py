...
class TripsRepo:
    ...
    async def get_available_trips(origin_id: Optional[int] = None,
        ...
        async with pool.acquire() as conn:
            query = """
            SELECT t.id AS trip_id, t.bus_id, t.price, t.status,
                   t.departure_time, t.arrival_time,
                   c_from.id AS origin_id, c_from.city_name AS origin_name,
                   c_to.id AS destination_id, c_to.city_name AS destination_name,
